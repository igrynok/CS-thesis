...
%Bertin and Atanassova \cite{marc1} designed FSA (finite state automata) to describe different types of bibliographic references. Example of FSA for alpha-numeric bibliographic reference is shown on Figure \ref{fig:fsa}. They then use FSA to build regular expressions matching bibliographic links. We use similar approach.

 % \begin{figure}[htp]
 %   \centering
 %   \includegraphics[scale=0.6]{fsa}
 %   \caption{Example of FSA for matching alpha-numeric bibliographic references}
 %   \label{fig:fsa}
 % \end{figure}
