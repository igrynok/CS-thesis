...
\begin{itemize}
	\item Design and implement Citation Search Engine.
	\item Deploy the system on the given collection of scientific papers.
	\item Make evaluation of the system by conducting user evaluation experiments.
	\item Analyze results, make a conclusion.
\end{itemize}

\section{Outline}
The rest of the paper structured as follows:
\begin{description}
	\item[Chapter \ref{cha:introduction}] This chapter Gives a high overview of the architecture of a typical web search engine. It describes the main steps to construct an inverted index.
	\item[Chapter \ref{cha:related-work}] This chapter surveys the research related to citations in scientific publications. It makes an overview of two popular academic search engines: Google Scholar and CiteSeer.
	\item[Chapter \ref{cha:CS}] This chapter describes the design of Citation Search Engine. It first shows overall architecture of the proposed system and then shows details of implementation of each component. 
	\item[Chapter \ref{cha:experiments}] This chapter describes user evaluation experiments and analysis the results.
	\item[Chapter \ref{cha:conclusion}] This chapter contains a conclusion and possible future work. 
\end{description}
\pagebreak
