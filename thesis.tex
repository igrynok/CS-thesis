...
\end{itemize} 
After filling the form each expert was introduced to the simple query syntax and to interfaces of search engines \ho{what search engines}. Then experiment begins with Task1 and Task1’. After Task1 and Task1’ experts were asked some general questions about their impressions on using Google Scholar and Citation Search, for example:
\begin{itemize}[noitemsep]
