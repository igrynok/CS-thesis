...
\begin{description}
	\item[Chapter 1] The chapter gives an overview of a typical web search engine and describes the possible ways of its enhancements. It describes one of the most popular search platform Solr, that will be used for building Citation Search Engine.
	\item[Chapter 2] Devoted to the exploring the structure of scientific papers and identifying future challenges.
...
\section{A typical web search engine}
\section{Indexator - Solr}
