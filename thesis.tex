...
This fact leads to an overall decrease of quality of research papers. \brs{Says who? it would be nice to have a reference for these claims}
...
This happens due to the \del{following} facts that they do not take document structure into account and they \ugh{search for claims}\brs{rephrase, they do not search for claims, not do they claim to} in the parts of documents that do not contain any claims at all, and therefore return a large amount of irrelevant results.
...
\ins{The} Following are the main contributions of this work:
\begin{itemize}
...
\section{Outline}
The rest of the paper structured as follows\brs{The ``CHAPTER X In Chapter X we'' form is ugly, rephrase so that there is only one mention of Chapter}:
\begin{description}
...
\begin{enumerate}
	\item Documents collection \brs{isn't this the crawlers job? if so, say: usulay performed by the crawler}
